      ...
      <section className="py-12 px-4 border-b border-cat-sand">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-6 text-center">
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="text-3xl font-display font-bold text-primary-600">200+</div>
            <div className="text-gray-500 text-sm mt-1">cats waiting for a home</div>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm">
            <div className="text-3xl font-display font-bold text-warm-600">50+</div>
            <div className="text-gray-500 text-sm mt-1">shelters in our database</div>
          </div>
          <div className="bg-white rounded-2xl p-6 shadow-sm">
